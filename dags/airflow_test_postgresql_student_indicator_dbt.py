...
dbt_run = BashOperator(
    task_id='dbt_run',
    bash_command='dbt run --profiles-dir ./dbt/dbt_project/.dbt/ --project-dir ./dbt/dbt_project/ --model --select ./dbt/dbt_project/models/kpis/company/student_indicators.sql',
