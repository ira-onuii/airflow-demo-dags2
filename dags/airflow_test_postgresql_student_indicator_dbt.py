...
dbt_run = BashOperator(
    task_id='dbt_run',
    bash_command='dbt run --profiles-dir /opt/dbt/dbt_project/.dbt --project-dir /opt/dbt/dbt_project --models /opt/dbt/dbt_project/models/KPIs/company/student_indicators.sql',
