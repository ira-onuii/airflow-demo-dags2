...
dbt_run = BashOperator(
    task_id='dbt_run',
    bash_command='dbt run --profiles-dir /opt/airflow/dbt/dbt_project/.dbt/ --project-dir /opt/airflow/dbt/dbt_project/ --model ./dbt/dbt_project/models/kpis/company/student_indicators.sql',
