...
dbt_run_student_indicator = BashOperator(
    ...
    bash_command='dbt run --profiles-dir /opt/airflow/dbt/dbt_project/.dbt --project-dir /opt/airflow/dbt/dbt_project --model --select ./models/KPIs/company/student_indicators.sql',
    dag=dag,
)
...
dbt_run_student_indicator >> dbt_run_tutoring_indicator
