...
pg_schema = 'data_dimensions'

table_name = 'nps_7_under_total_raw'

date_column = 'created_at'

column_list = ["lecture_vt_no","schedule_no","lecture_cycle_No","tutoring_datetime","schedule_state","student_id","teacher_id","created_at","fst_nps"]
columns_str = ", ".join(f'"{col}"' for col in column_list)

pk = 'schedule_no'

tags = ['2.0','raw','data_dimension','nps']
...
def incremental_extract():
    ...
    from dimension_query import group_lvt_query
    ...
    today_data_query = group_lvt_query
...
dag = DAG(
    f'data_dimensions-{table_name}-incremental_2.0',
