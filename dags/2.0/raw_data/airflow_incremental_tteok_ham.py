...
def save_results_to_s3(**context):
    ...
    column_names = ["tteok_ham_no","item_type","item_detailed_type","tteok_ham_type","group_no","shelf_life","months","tteok_ham_title","tteok_ham_subtitle1","tteok_ham_subtitle2","tteok_ham_subtitle3","tteok","honey_tteok","pass_limit","max_question_count","subjects","isshow","tteok_ham_price","base_price","discount_rate","discount_price","is_taxfree","bonus_tteok","bonus_honey_tteok","reg_datetime","showorder","device_combined"]
...
def incremental_extract():
    ...
    if table_exists:
        ...
        print('###False###')
        max_updatedat = '2019-01-01 00:00:00'
        df_before = pd.DataFrame(columns=["tteok_ham_no","item_type","item_detailed_type","tteok_ham_type","group_no","shelf_life","months","tteok_ham_title","tteok_ham_subtitle1","tteok_ham_subtitle2","tteok_ham_subtitle3","tteok","honey_tteok","pass_limit","max_question_count","subjects","isshow","tteok_ham_price","base_price","discount_rate","discount_price","is_taxfree","bonus_tteok","bonus_honey_tteok","reg_datetime","showorder","device_combined"])  # 필요한 컬럼으로 빈 df 생성
