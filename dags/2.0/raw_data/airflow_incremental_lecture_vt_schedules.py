...
table_name = 'lecture_vt_schedules'

date_column = 'update_datetime'

column_list = ['schedule_no','follow_no','lecture_vt_no','lecture_cycle_no','stage_count','cycle_count','is_free','offer_type','schedule_state','tutoring_datetime','last_tutoring_datetime','create_datetime','update_datetime','cycle_payment_item','interval_days','device_no','per_done_month']
