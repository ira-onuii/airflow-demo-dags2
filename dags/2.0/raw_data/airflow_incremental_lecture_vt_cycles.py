...
table_name = 'lecture_vt_cycles'

date_column = 'update_datetime'

column_list = ["lecture_cycle_No","lecture_vt_No","page_call_room_id","review","cycle_review","count_No","term_subject_d2_No","cycle_state","cycle_step","tutor_point","durations","tutor_price","req_datetime","update_datetime"]
