...
def scph_insert_postgres_data(**context):
    ...
    insert_query = warehouse_query2.scph_insert_query
...
dag = DAG(
    'data-warehouse-test-postgresql-scph_2.0',
...
scph_run_query = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query2.scph_select_query,
...
scph_delete_row = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query2.scph_delete_query
)
