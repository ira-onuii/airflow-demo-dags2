...
def las_insert_postgres_data(**context):
    ...
    insert_query = warehouse_query.las_insert_query
...
dag = DAG(
    'data-warehouse-test-postgresql-las',
...
las_run_query = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query.las_select_query,
...
las_delete_row = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query.las_delete_query
)
