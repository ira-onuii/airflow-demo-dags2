...
def incremental_extract():
    ...
    today_data = warehouse_query3.block_refund_select_query
    ...
    df_incremental = df_incremental[['id','refundedat','requestedat','state','memo','amount','paymentitemid','blockid','detailid','refundbankid','refundmethod']]
