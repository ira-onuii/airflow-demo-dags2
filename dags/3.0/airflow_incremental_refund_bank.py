...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','name','holder','code','accountnumber','isavailable','userid']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","name","holder","code","accountnumber","isavailable","userid"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','name','holder','code','accountnumber','isavailable','userid']]
