...
table_name = 'payment_item_benefit'
...
def save_results_to_s3(**context):
    ...
    column_names = ['paymentitemid','benefitid','value']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.payment_item_benefit_select_query
    ...
    df_incremental = df_union_all[['paymentitemid','benefitid','value']]
