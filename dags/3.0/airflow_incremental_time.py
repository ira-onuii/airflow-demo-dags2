...
def save_results_to_s3(**context):
    ...
    column_names = ['id','month','week','minute','paymentitemid']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.time_select_query
    ...
    df_incremental = df_union_all[['id','month','week','minute','paymentitemid']]
