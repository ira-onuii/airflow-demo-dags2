...
table_name = 'block_refund_reason'
...
def save_results_to_s3(**context):
    ...
    column_names = ['blockrefundid','refundreasonid']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.block_refund_reason_select_query
    ...
    df_incremental = df_union_all[['blockrefundid','refundreasonid']]
