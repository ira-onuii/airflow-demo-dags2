...
def incremental_extract():
    ...
    df_incremental = df_incremental[["idx","created_at","created_by","id","lecture_cycle_id","reserved_end_date_time","reserved_start_date_time","teacher_id","updated_at","flow","provider","status"]]
