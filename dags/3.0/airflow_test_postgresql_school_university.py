...
def school_university_insert_postgres_data(**context):
    ...
    insert_query = warehouse_query.school_university_insert_query
...
dag = DAG(
    'data-warehouse-test-postgresql-school_university',
...
school_university_run_query = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query.school_university_select_query,
...
school_university_delete_row = SQLExecuteQueryOperator(
    ...
    sql=warehouse_query.school_university_delete_query
)
