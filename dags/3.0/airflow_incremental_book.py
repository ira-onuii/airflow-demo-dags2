...
def save_results_to_s3(**context):
    ...
    column_names = ['id','publisher','blockid','isbn10','isbn13']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.book_select_query
    ...
    df_incremental = df_union_all[['id','publisher','blockid','isbn10','isbn13']]
