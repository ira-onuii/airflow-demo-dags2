...
# 
    ...
    df_incremental = df_incremental[["is_single","created_at","end_date_time","id","latest_lecture_cycle_id","latest_round_id","manager_id","start_date_time","updated_at","latest_fixed_package_id","status","subject_codes"]]
