...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','type','name','price','taxfreeamount','discountedvalue','supplyvalue','additionaltax','refundedamount','memo','uid','userid','count','isaddedtocart','paymentid']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","type","name","price","taxfreeamount","discountedvalue","supplyvalue","additionaltax","refundedamount","memo","uid","userid","count","isaddedtocart","paymentid"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','type','name','price','taxfreeamount','discountedvalue','supplyvalue','additionaltax','refundedamount','memo','uid','userid','count','isaddedtocart','paymentid']]
