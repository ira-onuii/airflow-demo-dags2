...
table_name = 'payment_used_billing_card'
...
def save_results_to_s3(**context):
    ...
    column_names = ['billingcardid','paymentid']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.payment_used_billing_card_select_query
    ...
    df_incremental = df_union_all[['billingcardid','paymentid']]
