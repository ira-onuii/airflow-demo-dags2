...
table_name = 'interest_free_installment'
...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','name','freemonth','pg']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","name","freemonth","pg"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','name','freemonth','pg']]
