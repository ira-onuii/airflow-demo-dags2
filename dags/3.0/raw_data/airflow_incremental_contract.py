...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','name','month','ownershiptype','isused','memo','devicetype','devicegeneration','memo2']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","name","month","ownershiptype","isused","memo","devicetype","devicegeneration","memo2"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','name','month','ownershiptype','isused','memo','devicetype','devicegeneration','memo2']]
