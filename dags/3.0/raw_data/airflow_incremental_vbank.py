...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','name','code','accountnumber','duedate','iscancelled','paymentid']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","name","code","accountnumber","duedate","iscancelled","paymentid"
    ...
    # 컬럼 순서 정렬
    df_incremental = df_today[['id','createdat','name','code','accountnumber','duedate','iscancelled','paymentid']]
