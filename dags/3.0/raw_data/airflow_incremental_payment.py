...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','paidat','refundedat','failedat','impuid','state','paymentmethod','paymentroute','price','deliveryfee','refundedamount','merchantuid','installmentperiod','pg','pgtid','applynumber','receipturl','memo','userid','discountedvalue','addressid','failreason','version']
...
def incremental_extract():
    ...
    if max_updatedat is None:
        max_updatedat = '2023-01-01 00:00:00'  # 기본값
    else:
        max_updatedat
    print(max_updatedat)
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","paidat","refundedat","failedat","impuid","state","paymentmethod","paymentroute","price","deliveryfee","refundedamount","merchantuid","installmentperiod","pg","pgtid","applynumber","receipturl","memo","userid","discountedvalue","addressid","failreason","version"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','paidat','refundedat','failedat','impuid','state','paymentmethod','paymentroute','price','deliveryfee','refundedamount','merchantuid','installmentperiod','pg','pgtid','applynumber','receipturl','memo','userid','discountedvalue','addressid','failreason','version']]
