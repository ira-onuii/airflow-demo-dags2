...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','userid','paidat','isconfirmed','paymentid','deviceid','contractid']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","userid","paidat","isconfirmed","paymentid","deviceid","contractid"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','userid','paidat','isconfirmed','paymentid','deviceid','contractid']]
