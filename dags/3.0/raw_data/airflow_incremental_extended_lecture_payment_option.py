...
table_name = 'extended_lecture_payment_option'
...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','lecturecontextid','userid','installmentperiod']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","lecturecontextid","userid","installmentperiod"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','lecturecontextid','userid','installmentperiod']]
