...
def save_results_to_s3(**context):
    ...
    column_names = ['id','settlementday','payoutamount','pgfee','type','paymentid','refunddetailid']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        'id','settlementday','payoutamount','pgfee','type','paymentid','refunddetailid'
    ...
    # 컬럼 순서 정렬
    df_incremental = df_today[['id','settlementday','payoutamount','pgfee','type','paymentid','refunddetailid']]
