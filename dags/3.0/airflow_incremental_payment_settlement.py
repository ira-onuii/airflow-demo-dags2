...
def incremental_extract():
    ...
    today_data = warehouse_query3.payment_settlement_select_query
    ...
    df_incremental = df_union_all[['id','settlementday','payoutamount','pgfee','type','paymentid','refunddetailid']]
