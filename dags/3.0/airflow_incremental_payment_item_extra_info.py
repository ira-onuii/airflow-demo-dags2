...
table_name = 'payment_item_extra_info'
...
def save_results_to_s3(**context):
    ...
    column_names = ['id','tteokhamid','paymentitemid','subjectid','lvtid','legacyitemid']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.payment_item_extra_info_select_query
    ...
    df_incremental = df_union_all[['id','tteokhamid','paymentitemid','subjectid','lvtid','legacyitemid']]
