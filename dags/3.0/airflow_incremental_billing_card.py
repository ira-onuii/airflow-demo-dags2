...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','updatedat','deletedat','userid','name','number','companyname','companycode','isrecentlyused','ismain','type','islegacy']
...
def incremental_extract():
    ...
    today_data = f'''
    select 
        "id","createdat","updatedat","deletedat","userid","name","number","companyname","companycode","isrecentlyused","ismain","type","islegacy"
    ...
    df_incremental = df_incremental[['id','createdat','updatedat','deletedat','userid','name','number','companyname','companycode','isrecentlyused','ismain','type','islegacy']]
