...
table_name = 'payment_item_discount'
...
def save_results_to_s3(**context):
    ...
    column_names = ['id','createdat','name','discountedvalue','benefitid','paymentitemid']
...
def incremental_extract():
    ...
    today_data = warehouse_query3.payment_item_discount_select_query
    ...
    df_incremental = df_union_all[['id','createdat','name','discountedvalue','benefitid','paymentitemid']]
